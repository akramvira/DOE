...
var WebService = /** @class */ (function () {
    ...
    WebService.prototype.getAllGroups = function () {
        ...
        return this.http.get(environment_1.environment.apiUrl + '/admin/groups/main', options);
    };
    WebService.prototype.removeGroup = function (groupId) {
        var options = this.authServ.getRequestOpions();
        return this.http.delete(environment_1.environment.apiUrl + '/admin/groups/main/' + groupId, options);
    };
    WebService.prototype.addGroup = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.post(environment_1.environment.apiUrl + '/admin/groups/main', data, options);
    };
    WebService.prototype.updateGroup = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.put(environment_1.environment.apiUrl + '/admin/groups/main/' + data['id'], data, options);
    };
    WebService.prototype.deleteGroup = function (id) {
        var options = this.authServ.getRequestOpions();
        return this.http.delete(environment_1.environment.apiUrl + '/admin/groups/main/' + id, options);
    };
