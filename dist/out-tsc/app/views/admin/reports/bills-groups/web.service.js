...
var WebService = /** @class */ (function () {
    ...
    WebService.prototype.getGroupPerformance = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.post(environment_1.environment.apiUrl + "/admin/reports/chart/numbers/filters", data, options);
    };
    WebService.prototype.getNumbers = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.post(environment_1.environment.apiUrl + "/admin/reports/departments/filteritems/getnumbers", data, options);
    };
    WebService.prototype.getBills = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.post(environment_1.environment.apiUrl + "/admin/reports/bill", data, options);
    };
