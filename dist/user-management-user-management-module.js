...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.addUser = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/admin/users", data, options);
    };
    //roles
    ...
    UsersService.prototype.updateUser = function (data) {
        var options = this.authServ.getRequestOpions();
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/admin/users/" + data["id"], data, options);
    };
    UsersService.prototype.deleteUser = function (id) {
        var options = this.authServ.getRequestOpions();
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/admin/users/" + id, options);
    };
...
var NewUserComponent = /** @class */ (function () {
    function NewUserComponent(userServ, toaster, authService, router) {
        ...
        this.onSubmitUser = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
var RolesComponent = /** @class */ (function () {
    ...
    RolesComponent.prototype.updateValue = function (event, cell, rowIndex) {
        ...
        this.RoleServ.updateRole({
            name: newName,
            id: id,
            value: _services_globals__WEBPACK_IMPORTED_MODULE_7__["Globals"].fetchData(this.selectedRoleAccesses, true)
...
/* harmony import */ var _new_user_new_user_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../new-user/new-user.component */ "./src/app/views/admin/user-management/new-user/new-user.component.ts");
...
var UsersComponent = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("editUserCmp"),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _new_user_new_user_component__WEBPACK_IMPORTED_MODULE_6__["NewUserComponent"])
