...
public lineChartData: Array<any> = [
  ...
  ngOnInit(  ): void {
    ...
    const chartsTimer = interval(2000)
    .subscribe(
      (data)=>{
        if (this.dashboardestroid)
        ...
        this.apiServ.getSysInfo().subscribe(
          (res) => {
            ...
            this.hardDoughnutChartData = [res['hard']['use'] , 100 - res['hard']['use']];
            ...
            if (this.lineChartData[3].data.length >  this.chartHsteps){
             ...
             this.lineChartData  = [
              ...
              {data: this.showCpu ? [...this.lineChartData[0].data , this.Cpu]:new Array( this.chartHsteps)   , label: 'Cpu'},
              {data: this.showMemory ? [...this.lineChartData[1].data, this.Memory] : new Array( this.chartHsteps) , label: 'Ram'},
              {data: this.showSwap? [...this.lineChartData[2].data, this.swap] :new Array( this.chartHsteps) , label: 'Swap'},
              {data: this.showActiveCalls ? [...this.lineChartData[3].data, this.activeCalls]: new Array( this.chartHsteps), label: 'Active Calls'}
            ];
