...
constructor() { }
public exportAsExcelFile(json: any[], excelFileName: string, type:string = 'excel'): void {
...
private saveAsExcelFile(buffer: any, fileName: string, type:XLSX.BookType = 'xlsx'): void {
